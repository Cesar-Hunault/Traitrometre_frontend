...
export const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={homeStyle.screen}>
      ...
      <View style={homeStyle.affichage}></View>

      <ScrollView style={homeStyle.historique}>
        <HistoriqueAllPlayers navigation={navigation} />
        <HistoriqueAllPlayers navigation={navigation} />
        <HistoriqueAllPlayers navigation={navigation} />
        <HistoriqueAllPlayers navigation={navigation} />
        <HistoriqueAllPlayers navigation={navigation} />
      ...
      <Modal visible={isVisibleModalAjout} animationType="none" transparent={true}>
        <AddTraitrise onClose={toggleModalAjout} />
      </Modal>

      <Modal visible={isVisibleModalGroup} animationType="none" transparent={true}>
